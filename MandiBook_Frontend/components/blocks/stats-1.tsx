      ...
      <div className="max-w-[1400px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-start">
          ...
          <div className="flex flex-col gap-8 sm:gap-10">
            ...
            >
              85% of farmers report MandiBook reduced their wait time at the
              mandi significantly
            </motion.h1>
            ...
            <motion.button
              ...
              className="px-8 py-4 rounded-2xl bg-[var(--primary)] text-[var(--primary-foreground)] font-semibold text-base sm:text-lg hover:opacity-90 transition-colors duration-200 w-fit"
            >
              Start booking now
            </motion.button>
          </div>
